...
# Git Branching:
  ...
  `main` branch. Creating git branch will create an exact copy of present state of the branch from
  where you are executing the branch creation command. We create git branches for testing, adding new
  feature, fixing bugs etc.
```
```bash
